...
static int get_format(int format) {
    switch (format) {
        ...
        case HAL_PIXEL_FORMAT_RGB_888:        return (uint)C2D_COLOR_FORMAT_888_RGB |
                                              (uint)C2D_FORMAT_SWAP_RB;
        case HAL_PIXEL_FORMAT_RGBX_8888:      return (uint)C2D_COLOR_FORMAT_8888_ARGB |
                                              (uint)C2D_FORMAT_SWAP_RB |
                                              (uint)C2D_FORMAT_DISABLE_ALPHA;
        case HAL_PIXEL_FORMAT_RGBA_8888:      return (uint)C2D_COLOR_FORMAT_8888_ARGB |
                                              (uint)C2D_FORMAT_SWAP_RB;
        ...
        case HAL_PIXEL_FORMAT_YCbCr_420_SP_TILED: return (uint)C2D_COLOR_FORMAT_420_NV12 |
                                                  (uint)C2D_FORMAT_MACROTILED;
